...
devices/*
- RM-Y168, VSX9300 - some device files I used for testing (for a Sony TV and a Pioneer Amp)
...
3) [Optional] Run '/sbin/ifconfig' to find the MAC address and configure your WAP to have a consistent IP address assigned
...
6) [Troubleshooting] If the menu item just jiggles the screen and doesn't switch to the display 
...
lynx -mime_header "http://192.168.0.74:8174/help"
